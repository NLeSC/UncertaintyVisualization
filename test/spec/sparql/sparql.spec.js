  ...
  describe('service', function() {
    ...
    describe('queryKnowledgeBase function', function() {
      ...
      it('should publish an error to Messagebus if the request was faulty', function() {
        ...
        httpBackend.whenGET('https://shrouded-gorge-9256.herokuapp.com/do_sparql?query=').respond(erroneousQueryResult);
        SparqlService.queryKnowledgeBase(badTestRequest);
        httpBackend.flush();
      ...
      it('should publish a success to Messagebus if the request was succesful', function() {
        ...
        httpBackend.whenGET('https://shrouded-gorge-9256.herokuapp.com/do_sparql?query=SELECT%20DISTINCT%20?source%20?doc%20%0AWHERE%20%7B%20%0A%20%20VALUES%20?event%20%7B%20%3Chttp://www.newsreader-project.eu/data/cars/2009/05/22/7VRY-F631-2PP8-S0NC.xml%23ev21%3E%20%7D%20%0A%20%20%7B%20%0A%20%20%20%20GRAPH%20?graph%20%7B%20?event%20?predicate%20?object%20.%20%7D%20%0A%20%20%20%20?graph%20prov:wasAttributedTo%20?source%20.%20%0A%20%20%20%20?graph%20gaf:denotedBy%20?mention%20.%20%0A%20%20%20%20BIND%20(STRBEFORE(STR(?mention),%22%23%22)%20as%20?doc)%20%0A%20%20%7D%20%0A%7D%20%0AORDER%20BY%20?doc&dataset=cars').respond(succesfulQueryResult);
        SparqlService.queryKnowledgeBase(testRequest);
        httpBackend.flush();
